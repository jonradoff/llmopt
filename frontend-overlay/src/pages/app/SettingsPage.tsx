...
import AccessKeysTab from './settings/AccessKeysTab';

type TabKey = 'profile' | 'security' | 'sessions' | 'billing' | 'access-keys';
...
export default function SettingsPage() {
  ...
  const tabs = useMemo(() => [
    ...
    { key: 'access-keys' as const, label: 'Access Keys' },
  ], [showSecurityTab]);
  ...
  return (
    <div>
      ...
      {/* Tab Navigation */}
      <div className="flex gap-1 mb-6 bg-dark-900/50 border border-dark-800 rounded-xl p-1 flex-wrap" role="tablist">
        {tabs.map(t => (
          <button
            key={t.key}
